...
2. ### Set up Google Sheets API and Credentials
   ...
   1. Setup OAuth for your Google Cloud Project and put the generated JSON in in file `comps/comp2023/apikeys.json`
   ...
   2. During first runtime, click the OAuth concent link printed to the console
